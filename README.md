 ...
 * **Playwright:** Infraestrutura de testes End-to-End (E2E) para simulação de interações reais, interceptação de rede e validação visual de componentes.
**Backend (Engine & API)**
